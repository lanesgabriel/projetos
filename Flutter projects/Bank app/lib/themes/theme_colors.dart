...
class ThemeColors {
  ...
  static const recentActivity = {
    'outcome': Color.fromRGBO(250, 0, 112, 1),
    'income': Color.fromRGBO(50, 205, 50, 1.0),
  };

  static const accountPoints = {
    'freeShipping': Color.fromRGBO(255, 175, 29, 1.0),
    'freeStreammingOneMonth': Color.fromRGBO(75, 89, 191, 1),
  };
